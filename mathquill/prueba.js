...
let texto = "Elipsoide";
console.log(texto);
console.log(ecuacionGeneral(2, 3, 1, -8, 6, -4, -3))

texto = "Esfera";
console.log(texto);
console.log(ecuacionGeneral(2, 2, 2, -8, 6, -4, -3))

texto = "Hiperboloide 1 hoja";
console.log(texto);
console.log(ecuacionGeneral(3, 4, -2, 6, -16, 8, -13))


texto = "Hiperboloide 2 hojas";
console.log(texto);
console.log(ecuacionGeneral(3, -43, -23, 6, -16, 8, -13))

texto = "Cilindro Elíptico";
console.log(texto);
console.log(ecuacionGeneral(1, 4, 0, -6, -16, 0, 21))
console.log(ecuacionGeneral(0, 1, 3, 0, 13, 4, 1))

texto = "Cilindro Hiperbólico";
console.log(texto);
console.log(ecuacionGeneral(-9, 4, 0, 0, 0, 0, -36))

texto = "Planos Paralelos";
console.log(texto);
console.log(ecuacionGeneral(1, 0, 0, 0, 0, 0, -16))

texto = "Origen";
console.log(texto);
console.log(ecuacionGeneral(25, 81, 36, 0, 0, 0, 0))

texto = "Cono Elíptico";
console.log(texto);
console.log(ecuacionGeneral(4, -2, 9, 0, 0, 0, 0))

texto = "Eje Coordenado";
console.log(texto);
console.log(ecuacionGeneral(16, 2, 0, 0, 0, 0, 0))
console.log(ecuacionGeneral(0, 35, 2, 0, 0, 0, 0))

texto = "Planos que se intersecan";
console.log(texto);
console.log(ecuacionGeneral(2, 0, -4, 0, 0, 0, 0))
console.log(ecuacionGeneral(0, -3, 1, 0, 0, 0, 0))

texto = "Plano Coordenado";
console.log(texto);
console.log(ecuacionGeneral(0, 2, 0, 0, 0, 0, 0))
console.log(ecuacionGeneral(0, 0, -5, 0, 0, 0, 0))

texto = "Paraboloide Elíptico";
console.log(texto);
console.log(ecuacionGeneral(3, 2, 0, -6, 8, -12, -13))
console.log(ecuacionGeneral(-3, -2, 0, -6, -8, -12, -13))
console.log(ecuacionGeneral(1, 1, 0, 1, 1, 1, 1))

texto = "Paraboloide Hiperbólico";
console.log(texto);
console.log(ecuacionGeneral(3, -2, 0, -6, 8, -12, -13))

texto = "Cilindro Parabólico";
console.log(texto);
console.log(ecuacionGeneral(0, 0, 1, 0, 4, 0, 0))
console.log(ecuacionGeneral(1, 0, 0, 1, 1, 0, 1))
console.log(ecuacionGeneral(1, 0, 0, 1, 1, 1, 1))
